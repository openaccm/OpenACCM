    ...
    def _compute_start_time(self):
        for record in self:
            ...
            if range_type == 'today':
                ...
                record.end_time = pendulum.now().subtract(days=7).end_of('day').to_datetime_string()
                record.previous_start_time = pendulum.now().subtract(days=14).start_of('day').to_datetime_string()
                record.previous_end_time = pendulum.now().subtract(days=14).end_of('day').to_datetime_string()
            elif range_type == 'last 30 days':
                record.start_time = pendulum.now().subtract(days=30).start_of('day').to_datetime_string()
                record.end_time = pendulum.now().subtract(days=30).end_of('day').to_datetime_string()
                record.previous_start_time = pendulum.now().subtract(days=60).start_of('day').to_datetime_string()
                record.previous_end_time = pendulum.now().subtract(days=60).end_of('day').to_datetime_string()
            elif range_type == 'last 90 days':
                record.start_time = pendulum.now().subtract(days=90).start_of('day').to_datetime_string()
                record.end_time = pendulum.now().subtract(days=90).end_of('day').to_datetime_string()
                record.previous_start_time = pendulum.now().subtract(days=180).start_of('day').to_datetime_string()
                record.previous_end_time = pendulum.now().subtract(days=180).end_of('day').to_datetime_string()
            elif range_type == 'last 365 days':
                record.start_time = pendulum.now().subtract(days=365).start_of('day').to_datetime_string()
                record.end_time = pendulum.now().subtract(days=365).end_of('day').to_datetime_string()
                record.previous_start_time = pendulum.now().subtract(days=730).start_of('day').to_datetime_string()
                record.previous_end_time = pendulum.now().subtract(days=730).end_of('day').to_datetime_string()
                ...
                record.previous_start_time = pendulum.now().subtract(days=30).start_of('day').to_datetime_string()
                record.previous_end_time = pendulum.now().subtract(days=30).end_of('day').to_datetime_string()
            elif range_type == 'this 90 days':
                record.start_time = pendulum.now().start_of('day').to_datetime_string()
                record.end_time = pendulum.now().add(days=90).end_of('day').to_datetime_string()
                record.previous_start_time = pendulum.now().subtract(days=90).start_of('day').to_datetime_string()
                record.previous_end_time = pendulum.now().subtract(days=90).end_of('day').to_datetime_string()
            elif range_type == 'this 365 days':
                record.start_time = pendulum.now().start_of('day').to_datetime_string()
                record.end_time = pendulum.now().add(days=365).end_of('day').to_datetime_string()
                record.previous_start_time = pendulum.now().subtract(days=365).start_of('day').to_datetime_string()
                record.previous_end_time = pendulum.now().subtract(days=365).end_of('day').to_datetime_string()
                ...
                record.start_time = pendulum.now().add(days=7).start_of('day').to_datetime_string()
                record.end_time = pendulum.now().add(days=7).end_of('day').to_datetime_string()
                record.previous_start_time = pendulum.now().subtract(days=7).start_of('day').to_datetime_string()
                record.previous_end_time = pendulum.now().subtract(days=7).end_of('day').to_datetime_string()
            elif range_type == 'next 30 days':
                record.start_time = pendulum.now().add(days=30).start_of('day').to_datetime_string()
                record.end_time = pendulum.now().add(days=30).end_of('day').to_datetime_string()
                record.previous_start_time = pendulum.now().subtract(days=30).start_of('day').to_datetime_string()
                record.previous_end_time = pendulum.now().subtract(days=30).end_of('day').to_datetime_string()
            elif range_type == 'next 90 days':
                record.start_time = pendulum.now().add(days=90).start_of('day').to_datetime_string()
                record.end_time = pendulum.now().add(days=90).end_of('day').to_datetime_string()
                record.previous_start_time = pendulum.now().subtract(days=90).start_of('day').to_datetime_string()
                record.previous_end_time = pendulum.now().subtract(days=90).end_of('day').to_datetime_string()
            elif range_type == 'next 365 days':
                record.start_time = pendulum.now().add(days=365).start_of('day').to_datetime_string()
                record.end_time = pendulum.now().add(days=365).end_of('day').to_datetime_string()
                record.previous_start_time = pendulum.now().subtract(days=365).start_of('day').to_datetime_string()
                record.previous_end_time = pendulum.now().subtract(days=365).end_of('day').to_datetime_string()
