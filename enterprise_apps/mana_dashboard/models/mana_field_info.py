...
class ManaDashboardFieldInfo(models.Model):
    ...
    title = fields.Char(string='title', related='field.field_description', readonly=True)
    
    field_name = fields.Char(string='Name', related='field.name', readonly=True)
    ...
    affect_by_global = fields.Boolean(string='Affect By Global', default=True)
